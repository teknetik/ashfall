    ...
    try:
        ...
        async with Client() as client:
            if snapshot()['session']['state'] == 'Paused':
                await tap('Escape')
            for camera in ['cam_whompah', 'cam_ring_front', 'cam_hill', 'cam_avenue', 'cam_gate']:
        ...
        print('PASS: ring gate rendering, movement, offline interaction, audio and full city loop', flush=True)
