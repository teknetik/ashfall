...
namespace MCPForUnity.Runtime.Helpers
{
    ...
    public static class UnityObjectIdCompat
    {
        ...
        {
#if UNITY_6000_6_OR_NEWER
            // Unity 6.6 leaves the obsolete method as a throwing stub. Resolve the
            // existing wire handle against live objects without fabricating a 64-bit ID.
            // Fail closed if two full EntityIds share the truncated wire handle.
            Object match = null;
            foreach (var candidate in Resources.FindObjectsOfTypeAll<Object>())
            {
                if (candidate.GetInstanceIDCompat() != instanceId) continue;
