...
namespace AthenHill.Editor
{
 public static class DistrictAtlas
 {
  ...
  {
   if(AssetDatabase.LoadAssetAtPath<Material>("Assets/AthenHill/Art/Imported/Meshy/Fidelity/Salvage_relay.mat"))
    throw new InvalidOperationException("Legacy atlas packing would overwrite restored source UVs/textures. Use the Fidelity material workflow and profile any new atlas separately.");
