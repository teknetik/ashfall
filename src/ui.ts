...
export function createUI(root: HTMLElement) {
  root.innerHTML = `
    ...
    <header class="identity"><p class="eyebrow">Phase 4 · The colonists</p><h1>Athen Hill</h1><p id="location" class="scope">West Gate</p></header>
    ...
    <footer class="explore-hint"><p class="route">West Gate <span>→</span> Hill Tree <span>→</span> Ring Gate <span>→</span> Lattice Jack</p><p class="desktop-help"><kbd>WASD</kbd> walk <b>·</b> <kbd>Shift</kbd> run <b>·</b> Right-drag look <b>·</b> <kbd>E</kbd> interact <b>·</b> <kbd>Esc</kbd> pause <b>·</b> <kbd>R</kbd> return</p><p class="touch-help">Arrows to walk · Drag the city to look</p></footer>
